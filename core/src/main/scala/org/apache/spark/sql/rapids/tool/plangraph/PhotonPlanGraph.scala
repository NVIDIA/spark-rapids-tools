...
/**
 * Platform-specific SparkPlanGraphNode and SparkPlanGraphCluster implementations for Photon.
...
/**
 * Platform-specific SparkPlanGraphNode for Photon execution plans.
 *
 ...
 */
case class PhotonSparkPlanGraphNode(
...
/**
 * Platform-specific SparkPlanGraphCluster for Photon execution plans.
 *
 ...
 */
case class PhotonSparkPlanGraphCluster(
    override val id: Long,
    actualName: String,
    actualDesc: String,
    sparkName: String,
