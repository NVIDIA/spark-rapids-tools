...
/**
 * Platform-specific SparkPlanGraphNode and SparkPlanGraphCluster implementations for RAPIDS.
 * These classes provide platform-specific information while maintaining compatibility with Spark's
 * execution plan graph structure.
 */

/**
 * Platform-specific SparkPlanGraphNode for RAPIDS execution plans.
 *
 ...
 */
case class RAPIDSSparkPlanGraphNode(
...
/**
 * Platform-specific SparkPlanGraphCluster for RAPIDS execution plans.
 *
 ...
 */
case class RAPIDSSparkPlanGraphCluster(
    override val id: Long,
    actualName: String,
    actualDesc: String,
    sparkName: String,
