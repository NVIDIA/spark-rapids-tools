...
class CliDBAzureLocalMode:  # pylint: disable=too-few-public-methods
    ...
    def qualification(cpu_cluster: str,
        ...
        :param  eventlogs: Event log filenames or Azure WASB storage directories
        ...
        :param remote_folder: An Azure WASB folder where the output is uploaded at the end of execution.
