...
class CliDataprocLocalMode:  # pylint: disable=too-few-public-methods
    ...
    def profiling(gpu_cluster: str = None,
        ...
        :param  gpu_cluster: The Dataproc-cluster on which the Spark applications were executed. The argument
                can be a Dataproc-cluster or a valid path to the cluster's properties file (json format)
                generated by the gcloud-CLI. If missing, then the argument executor_info has to be provided
        :param  executor_info: A path pointing to a yaml file containing the system information of a
                ...
                If missing, the wrapper pulls the executor info from the "gpu_cluster"
    ...
    def diagnostic(cluster: str,
                   ...
                   verbose: bool = False) -> None:
        """
        Diagnostic tool to collect information from Dataproc cluster, such as OS version, # of executor nodes,
