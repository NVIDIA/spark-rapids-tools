...
class CliDataprocLocalMode:  # pylint: disable=too-few-public-methods
    ...
    def qualification(cpu_cluster: str,
        ...
        :param exec_cluster: the cluster on which the Rapids tool will be running.
        ...
        wrapper_qual_options = {
            'platformOpts': {
                ...
                'deployMode': DeployMode.REMOTE_CLUSTER if exec_cluster else DeployMode.LOCAL,
            },
