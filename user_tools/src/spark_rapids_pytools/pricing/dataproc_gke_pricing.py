...
@dataclass
class DataprocGkeCatalogContainer(JSONPropertiesContainer):
...
@dataclass
class DataprocGkePriceProvider(PriceProvider):
    """
    ...
    def _create_catalogs(self):
        self.catalogs = {'gcloud': DataprocGkeCatalogContainer(prop_arg=self.cache_files['gcloud'])}
