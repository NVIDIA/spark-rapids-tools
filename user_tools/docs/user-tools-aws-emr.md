...
| **rapids_options**** | A list of valid [Qualification tool options](../../core/docs/spark-qualification-tool.md#qualification-tool-option). Note that "output-directory" flag is ignored, and that multiple "spark-property" is not supported.                                                                                                                                                                | N/A                                                                                                                 |     N    |
