...
class TestAppHandlers(unittest.TestCase):
    ...
    def test_add_fields_to_dataframe_basic(self):
        csv_data = 'a,b\n1,2\n3,4'
        ...
        assert result_df.dtypes.iloc[0] == 'string'
        assert result_df.dtypes.iloc[1] == 'string'
        # verify the entire dataframes are equal
        pd.testing.assert_frame_equal(expected_df, result_df)

    def test_add_fields_to_dataframe_empty(self):
        """
